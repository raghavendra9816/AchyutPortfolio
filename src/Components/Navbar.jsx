    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 lg:px-0">
      <div className="max-w-7xl mx-auto flex h-14 items-center ">
        <div className="md:mr-4 flex justify-between w-full">
          ...
          <nav className="md:flex hidden item-center space-x-6 text-lg font-medium">
            <a
              href="#about"
...
<button className="inline-flex  item-center justify-center rounded-md md:hidden" onClick={()=>{setMobileMenuOpen(!mobileMenuOpen)}}>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden ">
            <div className="space-y-1 px-2 pb-3 pt-2">
                ...
                <a href="#testinomials"  className="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900">Testinomials</a>
